...
function leafext_placementstrategies_params() {
	$params = array(
		...
		array(
			...
			__(
				'Strategy for placing markers in cluster',
		...
		array(
			'shapes',
			__( 'Type of marker', 'extensions-leaflet-map' ),
			'marker',
			array( 'circle', 'marker' ),
		),
		...
		array(
			'firstCircleElements',
			__( 'Number of elements in the first circle', 'extensions-leaflet-map' ),
			'10',
			array( '6', '8', '10', '12' ),
		),
		...
		array(
			'elementsMultiplier',
			__( 'Multiplicator of elements number for the next circle', 'extensions-leaflet-map' ),
			'1.5',
		...
		array(
			...
			__( 'Value to be added to each new circle distance value', 'extensions-leaflet-map' ),
			'30',
		...
		array(
			'maxClusterRadius',
			__( 'The maximum radius that a cluster will cover from the central marker (in pixels). Decreasing will make more, smaller clusters.', 'extensions-leaflet-map' ),
			'80',
