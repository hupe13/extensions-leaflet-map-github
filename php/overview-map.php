...
function leafext_ovm_setup_leafletmarker ($overview_data,$atts) {
		...
		if ($overview_data['thumbnail'] != "") {
			$overview_data['thumbnail'] = '<div class="popup-img">'.$overview_data['thumbnail'].'</div>';
		}
		//
		// categories
		if ($overview_data['categories'] != "") {
			$overview_data['categories'] = '<div class="popup-cat">'.$overview_data['categories'].'</div>';
		}
		//
		// Link
		...
		'<div class="popup">'.
		'<div class="popup-header">'.$link_to_page.'</div>'.
		$overview_data['thumbnail'].
		$overview_data['categories'].
		'</div>'.
		'[/'.$leaflet_marker_cmd.']';
