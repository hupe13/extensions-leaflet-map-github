(function(d,c){"object"===typeof exports&&"undefined"!==typeof module?c(exports):"function"===typeof define&&define.amd?define(["exports"],c):(d=d||self,c(d["leaflet-gesture-handling"]={}))})(this,function(d){var c={ar:{touch:"\u0627\u0633\u062a\u062e\u062f\u0645 \u0625\u0635\u0628\u0639\u064a\u0646 \u0644\u062a\u062d\u0631\u064a\u0643 \u0627\u0644\u062e\u0631\u064a\u0637\u0629",scroll:"\u200f\u0627\u0633\u062a\u062e\u062f\u0645 ctrl + scroll \u0644\u062a\u0635\u063a\u064a\u0631/\u062a\u0643\u0628\u064a\u0631 \u0627\u0644\u062e\u0631\u064a\u0637\u0629",
...
da:{touch:"Brug to fingre til at flytte kortet",scroll:"Brug ctrl + rullefunktionen til at zoome ind og ud p\u00e5 kortet",scrollMac:"Brug \u2318 + rullefunktionen til at zoome ind og ud p\u00e5 kortet"},de:{touch:"Verschieben der Karte mit zwei Fingern",scroll:"Verwende Strg + Scroll zum Zoomen der Karte",scrollMac:"Verwende \u2318 + Scroll zum Zoomen der Karte"},el:{touch:"\u03a7\u03c1\u03b7\u03c3\u03b9\u03bc\u03bf\u03c0\u03bf\u03b9\u03ae\u03c3\u03c4\u03b5 \u03b4\u03cd\u03bf \u03b4\u03ac\u03c7\u03c4\u03c5\u03bb\u03b1 \u03b3\u03b9\u03b1 \u03bc\u03b5\u03c4\u03b1\u03ba\u03af\u03bd\u03b7\u03c3\u03b7 \u03c3\u03c4\u03bf\u03bd \u03c7\u03ac\u03c1\u03c4\u03b7",
...
scrollMac:"\u6309 \u2318 \u52a0\u4e0a\u6efe\u52d5\u6372\u8ef8\u53ef\u4ee5\u7e2e\u653e\u5730\u5716"}};window.LanguageContent=c;var e=!1,f={text:{},duration:1700},g=L.Handler.extend({_isScrolling:!1,_isTouching:!1,_isFading:!1,addHooks:function(){this._handleTouch=L.bind(this._handleTouch,this);this._setGestureHandlingOptions();this._disableInteractions();this._map._container.addEventListener("touchstart",this._handleTouch);this._map._container.addEventListener("touchmove",this._handleTouch);this._map._container.addEventListener("touchend",
this._handleTouch);this._map._container.addEventListener("touchcancel",this._handleTouch);this._map._container.addEventListener("click",this._handleTouch);L.DomEvent.on(this._map._container,"wheel",this._handleScroll,this);L.DomEvent.on(this._map._container,"mouseenter",this._handleMouseOver,this);L.DomEvent.on(this._map._container,"mouseleave",this._handleMouseOut,this);L.DomEvent.on(this._map,"movestart",this._handleDragging,this);L.DomEvent.on(this._map,"move",this._handleDragging,this);L.DomEvent.on(this._map,
"moveend",this._handleDragging,this);this._map.on("popupopen",this._handleScrollOnPopup,this);this._map.on("popupclose",this._handleScrollOnPopup,this);L.DomEvent.off(this._map,"enterFullscreen",this._onEnterFullscreen,this);L.DomEvent.off(this._map,"exitFullscreen",this._onExitFullscreen,this);L.DomEvent.on(this._map,"enterFullscreen",this._onEnterFullscreen,this);L.DomEvent.on(this._map,"exitFullscreen",this._onExitFullscreen,this);L.DomUtil.addClass(this._map._container,"leaflet-gesture-handling")},
removeHooks:function(){this._enableInteractions();this._map._container.removeEventListener("touchstart",this._handleTouch);this._map._container.removeEventListener("touchmove",this._handleTouch);this._map._container.removeEventListener("touchend",this._handleTouch);this._map._container.removeEventListener("touchcancel",this._handleTouch);this._map._container.removeEventListener("click",this._handleTouch);L.DomEvent.off(this._map._container,"wheel",this._handleScroll,this);L.DomEvent.off(this._map._container,
"mouseenter",this._handleMouseOver,this);L.DomEvent.off(this._map._container,"mouseleave",this._handleMouseOut,this);L.DomEvent.off(this._map,"movestart",this._handleDragging,this);L.DomEvent.off(this._map,"move",this._handleDragging,this);L.DomEvent.off(this._map,"moveend",this._handleDragging,this);this._map.off("popupopen",this._handleScrollOnPopup,this);this._map.off("popupclose",this._handleScrollOnPopup,this);L.DomUtil.removeClass(this._map._container,"leaflet-gesture-handling")},_handleDragging:function(a){"movestart"==
a.type||"move"==a.type?e=!0:"moveend"==a.type&&(e=!1)},_disableInteractions:function(){this._map.dragging.disable();this._map.scrollWheelZoom.disable();this._map.tap&&this._map.tap.disable()},_enableInteractions:function(){this._map.dragging.enable();this._map.scrollWheelZoom.enable();this._map.tap&&this._map.tap.enable();var a=-1<navigator.userAgent.indexOf("Chrome"),b=-1<navigator.userAgent.indexOf("Safari");!a&&b&&this._map.tap.disable()},_enableWarning:function(a){clearTimeout(this._isFading);
L.DomUtil.addClass(this._map._container,"leaflet-gesture-handling-"+a);L.DomUtil.addClass(this._map._container,"leaflet-gesture-handling-warning")},_disableWarning:function(a,b){clearTimeout(this._isFading);this._isFading=setTimeout(L.bind(function(a){L.DomUtil.removeClass(this._map._container,"leaflet-gesture-handling-"+a)},this,a),b||this._map.options.gestureHandlingOptions.duration);L.DomUtil.removeClass(this._map._container,"leaflet-gesture-handling-warning")},_isLanguageContent:function(a){return a&&
a.touch&&a.scroll&&a.scrollMac},_isMacUser:function(){return 0<=navigator.platform.toUpperCase().indexOf("MAC")},_parseGestureHandlingOptions:function(){var a=L.extend(this._map.options.gestureHandlingOptions,f);this._map.options.gestureHandlingText&&(a.text=this._map.options.gestureHandlingText);return a},_setGestureHandlingOptions:function(){var a=this._parseGestureHandlingOptions(),a=this._isLanguageContent(a.text)?a.text:this._getLanguageContent(a.locale);this._map._container.setAttribute("data-gesture-handling-touch-content",
a.touch);this._map._container.setAttribute("data-gesture-handling-scroll-content",a.scroll);this._touchWarning=a.touch;this._scrollWarning=a.scroll},_getUserLanguage:function(){return navigator.languages?navigator.languages[0]:navigator.language||navigator.userLanguage},_getLanguageContent:function(a){a=a||this._getUserLanguage()||"en";var b=c[a],b=(b=b||-1===a.indexOf("-")?b:c[a.split("-")[0]])||c.en;b.scroll=this._isMacUser()?b.scrollMac:b.scroll;return b},_hasClass:function(a,b){for(var c=0;c<
b.length;c++)if(L.DomUtil.hasClass(a,b[c]))return!0;return!1},_handleTouch:function(a){var b=this._hasClass(a.target,"leaflet-control-minimap leaflet-interactive leaflet-popup-content leaflet-popup-content-wrapper leaflet-popup-close-button leaflet-control-zoom-in leaflet-control-zoom-out".split(" ")),c=null!=a.target.offsetParent&&null!=a.target.offsetParent.classList&&"undefined"!==typeof a.target.offsetParent.classList?a.target.offsetParent.classList.toString().indexOf("leaflet-control"):-1;b||
-1!=c?L.DomUtil.hasClass(a.target,"leaflet-interactive")&&"touchmove"===a.type&&1===a.touches.length?this._enableTouchWarning():this._disableTouchWarning():"touchmove"!==a.type&&"touchstart"!==a.type?this._disableTouchWarning():1===a.touches.length?this._enableTouchWarning():(this._disableTouchWarning(),this._enableInteractions())},_enableTouchWarning:function(){this._enableWarning("touch");this._disableInteractions()},_disableTouchWarning:function(a){clearTimeout(this._isTouching);this._isTouching=
setTimeout(L.bind(function(){this._disableWarning("touch")},this),a||0)},_enableScrollWarning:function(){this._enableWarning("scroll");this._map.scrollWheelZoom.disable()},_disableScrollWarning:function(a){clearTimeout(this._isScrolling);this._isScrolling=setTimeout(L.bind(function(){this._disableWarning("scroll");this._map.scrollWheelZoom.enable()},this),a||0)},_handleScroll:function(a){a.metaKey||a.ctrlKey||a.shiftKey&&this._map._rotate?(a.preventDefault(),this._disableScrollWarning()):(this._enableScrollWarning(),
this._disableScrollWarning(this._map.options.gestureHandlingOptions.duration))},_handleScrollOnPopup:function(a){L.DomEvent["popupopen"==a.type?"on":"off"](a.popup._contentNode,"wheel",this._handleScroll,this)},_handleMouseOver:function(a){this._enableInteractions()},_handleMouseOut:function(a){e||this._disableInteractions()},_onExitFullscreen:function(){this._map.options.gestureHandling&&this._map.gestureHandling.enable()},_onEnterFullscreen:function(){this._map.options.gestureHandling&&this._map.gestureHandling.disable()}});
L.Map.mergeOptions({gestureHandlingOptions:f});L.Map.addInitHook("addHandler","gestureHandling",g);d.GestureHandling=g;Object.defineProperty(d,"__esModule",{value:!0})});
