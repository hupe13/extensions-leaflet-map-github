...
b.length;c++)if(L.DomUtil.hasClass(a,b[c]))return!0;return!1},_handleTouch:function(a){var b=this._hasClass(a.target,"leaflet-control-minimap leaflet-interactive leaflet-popup-content leaflet-popup-content-wrapper leaflet-popup-close-button leaflet-control-zoom-in leaflet-control-zoom-out".split(" ")),c=a.target.offsetParent.classList.toString().indexOf("leaflet-control");b||-1!=c?L.DomUtil.hasClass(a.target,"leaflet-interactive")&&"touchmove"===a.type&&1===a.touches.length?this._enableTouchWarning():
this._disableTouchWarning():"touchmove"!==a.type&&"touchstart"!==a.type?this._disableTouchWarning():1===a.touches.length?this._enableTouchWarning():(this._disableTouchWarning(),this._enableInteractions())},_enableTouchWarning:function(){this._enableWarning("touch");this._disableInteractions()},_disableTouchWarning:function(a){clearTimeout(this._isTouching);this._isTouching=setTimeout(L.bind(function(){this._disableWarning("touch")},this),a||0)},_enableScrollWarning:function(){this._enableWarning("scroll");
