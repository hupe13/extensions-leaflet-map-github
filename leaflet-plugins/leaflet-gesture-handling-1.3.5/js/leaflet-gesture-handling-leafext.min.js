...
b.length;c++)if(L.DomUtil.hasClass(a,b[c]))return!0;return!1},_handleTouch:function(a){var b=this._hasClass(a.target,"leaflet-control-minimap leaflet-interactive leaflet-popup-content leaflet-popup-content-wrapper leaflet-popup-close-button leaflet-control-zoom-in leaflet-control-zoom-out".split(" ")),c="undefined"!==typeof a.target.offsetParent?a.target.offsetParent.classList.toString().indexOf("leaflet-control"):-1;b||-1!=c?L.DomUtil.hasClass(a.target,"leaflet-interactive")&&"touchmove"===a.type&&
1===a.touches.length?this._enableTouchWarning():this._disableTouchWarning():"touchmove"!==a.type&&"touchstart"!==a.type?this._disableTouchWarning():1===a.touches.length?this._enableTouchWarning():(this._disableTouchWarning(),this._enableInteractions())},_enableTouchWarning:function(){this._enableWarning("touch");this._disableInteractions()},_disableTouchWarning:function(a){clearTimeout(this._isTouching);this._isTouching=setTimeout(L.bind(function(){this._disableWarning("touch")},this),a||0)},_enableScrollWarning:function(){this._enableWarning("scroll");
this._map.scrollWheelZoom.disable()},_disableScrollWarning:function(a){clearTimeout(this._isScrolling);this._isScrolling=setTimeout(L.bind(function(){this._disableWarning("scroll");this._map.scrollWheelZoom.enable()},this),a||0)},_handleScroll:function(a){a.metaKey||a.ctrlKey||a.shiftKey&&this._map._rotate?(a.preventDefault(),this._disableScrollWarning()):(this._enableScrollWarning(),this._disableScrollWarning(this._map.options.gestureHandlingOptions.duration))},_handleScrollOnPopup:function(a){L.DomEvent["popupopen"==
a.type?"on":"off"](a.popup._contentNode,"wheel",this._handleScroll,this)},_handleMouseOver:function(a){this._enableInteractions()},_handleMouseOut:function(a){e||this._disableInteractions()},_onExitFullscreen:function(){this._map.options.gestureHandling&&this._map.gestureHandling.enable()},_onEnterFullscreen:function(){this._map.options.gestureHandling&&this._map.gestureHandling.disable()}});L.Map.mergeOptions({gestureHandlingOptions:f});L.Map.addInitHook("addHandler","gestureHandling",g);d.GestureHandling=
