	...
	return {
		...
		summary: {
			"minacceleration"  : {
				...
				value: (track, unit) => (tooltipvalue(track.acceleration_min, 2) || 0) + '&nbsp;' + unit,
				order: 60
			},
			"maxacceleration"  : {
				label: "Max Acceleration: ",
				value: (track, unit) => (tooltipvalue(track.acceleration_max, 2) || 0) + '&nbsp;' + unit,
				order: 61
			},
			"avgacceleration": {
				label: "Avg Acceleration: ",
				value: (track, unit) => (tooltipvalue(track.acceleration_avg, 2) || 0) + '&nbsp;' + unit,
				order: 62
			},
		}
	};
