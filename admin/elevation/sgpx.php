...
function leafext_sgpx_help_text() {
	...
	printf( esc_html__( 'This page helps you to migrate from %1$s to %2$s.', 'extensions-leaflet-map' ), '<code>sgpx</code>', '<code>elevation</code>' );
	...
	if ( LEAFEXT_SGPX_ACTIVE ) {
		echo '<li>';
		printf( esc_html__( 'Configure your default %s settings.', 'extensions-leaflet-map' ), '<a href="?page=' . LEAFEXT_PLUGIN_SETTINGS . '&tab=elevation">elevation</a>' );
		echo '</li><li>';
		...
		echo '</li>';
		echo '<li>';
		printf( esc_html__( 'To manage your tracks now, you can use %1$sFiles for Leaflet Map%2$s.', 'extensions-leaflet-map' ), '<a href="?page=' . LEAFEXT_PLUGIN_SETTINGS . '&tab=filemgr">', '</a>' );
		echo '</li>';
		echo '<li>';
