...
<p>'.
__('You may go to','extensions-leaflet-map').' <a href="admin.php?page=extensions-leaflet-map&tab=elevation">'.
__('Settings','extensions-leaflet-map').'</a> '.
__('and select a color theme','extensions-leaflet-map').'.</p>
