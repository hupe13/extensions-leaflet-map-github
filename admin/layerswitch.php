...
function leafext_form_maps() {
	...
	foreach ($options as $option) {
		...
		echo '<input type="text"  size="80"
			placeholder="'.__('e.g:','extensions-leaflet-map').' '.
...
function leafext_maps_help_text() {
	...
	<h2>About Tile servers</h2>
	<p>The default Map Tiles are defined in the
	<a href="'.get_admin_url().'admin.php?page=leaflet-map">Leaflet Map Settings</a>
	with the options tileurl, subdomains and attribution. You can define additionally
 Tile Servers here.</p>
