...
<ul>
<li><a href="https://github.com/Raruto/leaflet-elevation">leaflet-elevation</a>: A Leaflet plugin that allows to add elevation profiles using d3js.</li>
<li><a href="https://github.com/makinacorpus/Leaflet.GeometryUtil">Leaflet.GeometryUtil</a></li>
<li><a href="https://github.com/yohanboniface/Leaflet.i18n">Leaflet.i18n</a>: Internationalisation module for Leaflet plugins.</li>
<li><a href="https://github.com/Raruto/leaflet-rotate">leaflet-rotate</a>: A Leaflet plugin that allows to add rotation functionality to map tiles</li>
<li><a href="https://github.com/makinacorpus/Leaflet.AlmostOver">Leaflet.AlmostOver</a>: This plugin allows to detect mouse click and overing events on lines, with a tolerance distance.</li>
<li><a href="https://www.npmjs.com/package/@tmcw/togeojson">@tmcw/togeojson</a>: Convert KML, GPX, and TCX to GeoJSON.</li>
<li><a href="https://github.com/d3/d3">d3js</a>: Data-Driven Documents</li>
<li><a href="https://github.com/leaflet-extras/leaflet-providers">Leaflet-providers</a>: An extension that contains configurations for various tile providers.</li>
<li><a href="https://github.com/dayjournal/Leaflet.Control.Opacity">Leaflet.Control.Opacity</a>: Makes multiple tile layers transparent.</li>
<li><a href="https://github.com/Leaflet/Leaflet.markercluster">Leaflet.markercluster</a>: Provides Beautiful Animated Marker Clustering functionality.</li>
<li><a href="https://github.com/adammertel/Leaflet.MarkerCluster.PlacementStrategies">Leaflet.MarkerCluster.PlacementStrategies</a>: Styling Markerclusters.</li>
<li><a href="https://github.com/coryasilva/Leaflet.ExtraMarkers">Leaflet.ExtraMarkers</a>: Shameless copy of Awesome-Markers with more shapes and colors.</li>
<li><a href="https://github.com/ghybs/Leaflet.FeatureGroup.SubGroup">Leaflet.FeatureGroup.SubGroup</a>: Grouping of Leaflet elements by options and features.</li>
<li><a href="https://github.com/stefanocudini/leaflet-search">Leaflet Control Search</a>: Search Markers/Features location by option or custom property.</li>
<li><a href="https://github.com/timwis/leaflet-choropleth">leaflet-choropleth</a>: Choropleth plugin for Leaflet (color scale based on value).</li>
<li><a href="https://github.com/torfsen/leaflet.zoomhome">leaflet.zoomhome</a>: Provides a zoom control with a &quot;Home&quot; button to reset the view.</li>
<li><a href="https://github.com/brunob/leaflet.fullscreen">leaflet.fullscreen</a>: Simple plugin for Leaflet that adds fullscreen button to your maps.</li>
<li><a href="https://github.com/Raruto/leaflet-gesture-handling">Leaflet.GestureHandling</a>: A Leaflet plugin that allows to prevent default map scroll/touch behaviours.</li>
<li><a href="https://github.com/Turfjs/turf">turf</a>: Advanced geospatial analysis for browsers and Node.js</li>
</ul>';
