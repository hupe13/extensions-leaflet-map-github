...
function leafext_help_table($leafext_plugin_name="") {
	...
	<tr><td>'.__('Grouping features','extensions-leaflet-map').'</td><td><a href="?page='.$leafext_plugin_name.'&tab=featuregroup">leaflet-optiongroup, leaflet-featuregroup</a></td><td><a href="https://github.com/ghybs/Leaflet.FeatureGroup.SubGroup">Leaflet.FeatureGroup.SubGroup</a></td></tr>
